...
extern const u8 gText_RGSTAnne[];
extern const u8 gText_RGViridianForest[];
extern const u8 gText_RGLavender[];
extern const u8 gText_RGPokeTower[];
extern const u8 gText_RGPokeMansion[];
extern const u8 gText_RGSilphCo[];
extern const u8 gText_RGRocketHideout[];
...
extern const u8 gText_OldRodChapter[];
extern const u8 gText_GoodRodChapter[];
extern const u8 gText_SuperRodChapter[];
