...
const u8 gText_OldRodChapter[] = _("OLD ROD Fishing");
const u8 gText_GoodRodChapter[] = _("GOOD ROD Fishing");
const u8 gText_SuperRodChapter[] = _("SUPER ROD Fishing");
...
const u8 gText_RGSTAnne[] = _("MUS RG SANTOAN");
const u8 gText_RGViridianForest[] = _("MUS RG T MORI");
const u8 gText_RGLavender[] = _("MUS RG SHION");
const u8 gText_RGPokeTower[] = _("MUS RG P TOWER");
const u8 gText_RGPokeMansion[] = _("MUS RG POKEYASHI");
const u8 gText_RGSilphCo[] = _("MUS RG SHIRUHU");
const u8 gText_RGRocketHideout[] = _("MUS RG AJITO");
